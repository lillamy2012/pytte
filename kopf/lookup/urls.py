...
urlpatterns = patterns('',
        ...
        url(r'^seqtype/', views.seqtype, name='seqtype'),
        url(r'^listseqtype/', views.listseqtype, name='listseqtype'),
        url(r'^antibody/', views.antibody, name='antibody'),
        url(r'^addab/$',views.addab, name='addab'),
        url(r'^add/$',views.add, name='add'),
        url(r'^addseed/$',views.addseed, name='addseed'),
        url(r'^seeparents/(?P<pk>.*)$',views.seeparents, name='seeparents'),
        url(r'^addnewseed/$',views.addnewseed, name='addnewseed'),
        url(r'^addcontact/$',views.addcontact, name='addcontact'),
        url(r'^seecontact/$',views.seecontact, name='seecontact'),
                       #url(r'^tissue/', views.seqtype, name='tissue'),
        ...
        url(r'^multiplex/$', views.multiplex,name='multiplex'),
